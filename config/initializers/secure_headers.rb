SecureHeaders::Configuration.default do |config|
    ...
    config.csp.script_src = %w('self' 'unsafe-inline' *.google-analytics.com *.googletagmanager.com *.cloudfront.net *.fontawesome.com *.jquery.com *.cloudflare.com *.bootstrapcdn.com)
end
