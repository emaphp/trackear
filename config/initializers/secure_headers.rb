SecureHeaders::Configuration.default do |config|
    ...
    config.csp.script_src = %w('self' 'unsafe-inline' trackear-prod-2.s3.amazonaws.com *.google-analytics.com *.googletagmanager.com *.cloudfront.net *.fontawesome.com *.jquery.com *.cloudflare.com *.bootstrapcdn.com)
end
